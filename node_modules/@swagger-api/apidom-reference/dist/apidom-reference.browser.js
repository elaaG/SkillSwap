...
/* harmony import */ var _File_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(682);
/* harmony import */ var _util_plugins_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7427);
/* harmony import */ var _errors_ResolveError_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4312);
/* harmony import */ var _errors_UnmatchedResolverError_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9353);
...
const readFile = async (file, options) => {
  ...
  if (cachedError !== null) {
    throw new _errors_ResolveError_ts__WEBPACK_IMPORTED_MODULE_0__["default"](`Error while reading file "${file.uri}"`, {
      cause: cachedError
    });
  }
  ...
  const resolvers = await _util_plugins_ts__WEBPACK_IMPORTED_MODULE_1__.filter('canRead', [file, options], optsBoundResolvers);

  // we couldn't find any resolver for this File
  if ((0,ramda__WEBPACK_IMPORTED_MODULE_2__["default"])(resolvers)) {
    throw new _errors_UnmatchedResolverError_ts__WEBPACK_IMPORTED_MODULE_3__["default"](file.uri);
  }
  try {
    const {
      result
    } = await _util_plugins_ts__WEBPACK_IMPORTED_MODULE_1__.run('read', [file], resolvers);
    const stringifiedData = new _File_ts__WEBPACK_IMPORTED_MODULE_4__["default"]({
      ...file,
      data: result
    }).toString();
